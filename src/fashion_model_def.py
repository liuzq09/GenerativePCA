...
from mnist_e2e import model_def_fashion as fashion_vae_model_def
...
def construct_gen(hparams, model_def):
    ...
    x_hat = model_def.generator(model_hparams, z, 'gen', reuse=False)
...
def vae_gen(hparams):
    return construct_gen(hparams, fashion_vae_model_def)
